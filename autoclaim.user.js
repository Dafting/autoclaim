    ...
    let objectGenerator = {
        ...
        createManager: function() {
            ...
            const sites = [
                ...
                { id: '17', name: 'FreeBitco.in', cmc: '1', url: new URL('https://freebitco.in/'), rf: '?r=47887425', type: K.WebType.FREEBITCOIN, clId: 36 },
            ...
            let loader = function() {
                ...
                async function addSites() {
                    ...
                    webList.forEach(function (element, idx, arr) {
                        ...
                        if (element.id == '58' || element.id == '59' || element.id == '67') { //58, 59: BetFury x2 + 67: BFG
                            arr[idx].params['defaults.nextRun.override'] = true;
                            arr[idx].params['defaults.nextRun.useCountdown'] = false;
                            arr[idx].params['defaults.nextRun'] = 0;
